...
if age >= 25 && good_driving_record == true
    puts "Great, what kind of car do you need today? You also get a discount!"
elsif age >= 25 || good_driving_record == true
    puts "What kind of car do you need today?"
elsif age < 25 && good_driving_record != true 
    puts "Please provide a co-signer for this rental!"
end
